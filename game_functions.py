...
def ship_hit(ai_settings, stats, screen, ship, aliens, bullets, ship_left):
...
def check_events(ai_settings, screen, stats, ship, bullets, play_button, aliens):
    ...
    for event in pygame.event.get():
        ...
        # Reset the game state if needed, such as:
